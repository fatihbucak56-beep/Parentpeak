...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'moreLabel': 'More',
        'treasureTileTitle': 'Kids Treasure Box',
        'treasureTileSubtitle': 'Share locally, pass things on with ease',
    ...
    'de': {
      ...
      'moreLabel': 'Mehr',
        'treasureTileTitle': 'Kinder-Schatzkiste',
        'treasureTileSubtitle': 'Lokal tauschen, leicht weitergeben',
